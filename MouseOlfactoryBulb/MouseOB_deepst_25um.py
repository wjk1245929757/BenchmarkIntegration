...
for i in range(len(data_name_list)):
    ...
    if data_name_list[i] == "stereo":
        adata = read_stereoSeq_h5ad(path=data_path + '/' + data_name_list[i] + '.h5ad')
    ...
    if data_name_list[i] == "slide":
        adata = read_SlideSeq_h5ad(path=data_path + '/' + data_name_list[i] + '.h5ad')
...
deepst_embed.to_csv(save_path + '/mouseOB_25um_embedding.csv')
...
multiple_adata.filename = save_path + '/mouseOB_25um.h5ad'
print(multiple_adata.isbacked)
